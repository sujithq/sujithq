...
* [github: npm bulk trusted publishing config and script security now generally available](https://quintelier.dev/updates/npm-bulk-trusted-publishing-config-and-script-security-now-generally-available/)
