...
* [github: Secret scanning improves private key detection, updates Sentry pattern names](https://quintelier.dev/updates/secret-scanning-improves-private-key-detection-updates-sentry-pattern-names/)
