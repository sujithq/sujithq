...
* [github: Upcoming deprecation of select Copilot models from Claude, OpenAI, and Gemini](https://quintelier.dev/updates/upcoming-deprecation-of-select-copilot-models-from-claude-openai-and-gemini/)
